<h1> This is a fork of <a href="https://github.com/fuzzylite/fuzzylite">fuzzy-lite</a> that provides build
files for Microsoft VC 2013</h1>

<br>
The project to build the library is contained in the directory named "fuzzy-lite"
<br>
The project to test the library is in "fuzzy-test"
<br>
please see the project configuration settings for information on 
how to build with the library (I link to dbghelp.lib to resolve the examples compilation issue)
